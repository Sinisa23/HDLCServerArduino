...
//---------------------------------------------------------------------------
const char* ssid = "Razvoj novi";
const char* password = "bazdarnica1";
...
uint32_t SERIAL_NUMBER = 10610032; //bilo je 303

#define HDLC_HEADER_SIZE 160 //ovdje je bilo 17
#define HDLC_BUFFER_SIZE 751 //ovdje je bilo 128
#define PDU_BUFFER_SIZE 751 // ovdje je bilo 512
  ...
  gxByteBuffer * password)
{
  ...
  if (authentication == DLMS_AUTHENTICATION_NONE)
  {
    ...
    return DLMS_SOURCE_DIAGNOSTIC_AUTHENTICATION_MECHANISM_NAME_REQUIRED; //ovo je bilo u komentaru po defaultu
